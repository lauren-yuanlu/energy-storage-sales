<template>
  <div class="energyStorageSales">
    ...
    <form id="submitForm" action="" method="post" style="display:none"></form>
  </div>
</template>

<script>
import { Field, Button, Popup, Area, Picker, Dialog } from 'vant';
import {
  getProductById,
  placeOrder,
  getConfig
...
export default {
  ...
  methods: {
    ...
    //       console.log("000",newInput.value);
    //       document.forms[0].appendChild(newInput)
    //     } else {
    //       newInput.name = key
    //       newInput.type = "text"
    ...
    //     // newInput.type = "text"
    //     // newInput.value = json_str3[key]
    //     // newInput.subOrders=JSON.stringify(json_str3.subOrders)
    //     // document.forms[0].appendChild(newInput)
    //   }
